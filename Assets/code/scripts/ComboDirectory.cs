...
namespace Assets.Code.Scripts {
    ...
    public static class ComboDirectory {
        ...
        public static Combo slam = new Combo(new Tuple<string, string>[] { Tuple.Create(Constants.BUTTON, Constants.A_BUTTON), Tuple.Create(Constants.LEFTJOY, Constants.DOWN) }, 0.5f);
        ...
        public static Combo crystalShard = new Combo(new Tuple<string, string>[] { Tuple.Create(Constants.RIGHTJOY, Constants.LEFT_AND_RIGHT) }, 0.5f);
    }
}
